...
exports.clientList=async(req,res)=>{
  try {
   ...
   return res.render('./general/clientList.ejs',{clientData:clientData,messages:req.flash()})
  } catch (error) {
    console.log(error)
    req.flash('error','Something Went Wrong')
    return res.redirect('/login')
  ...
  try {
    ...
    if(!data){
      ...
      console.log(json_data)
        ...
        return res.render('./general/clientEdit.ejs',{data:data,json_data:json_data,messages:req.flash()})
    }
  } catch (error) {
    console.log(error)
    req.flash('error',"something went wrong")
...
exports.clientDelete = async (req, res) => {
  try {
    const data=await clientModel.findOne({where:{id:req.params.id}})
      const dataDelete = await clientModel.update({ isDeleted: 1 }, { where: { id: req.params.id } })
...
exports.adminDepartment=async(req,res)=>{
  try {
    ...
    return res.render('./admin/adminDepartment.ejs',{data:data,messages:req.flash()})
  } catch (error) {
    console.log(error)
    req.flash('error','Something Went Wrong')
    return res.redirect('/login')
...
exports.editDepartment=async(req,res)=>{
  try {
    ...
    return res.render('./admin/editDepartment.ejs',{editData:editData,data:data,messages:req.flash()})
  } catch (error) {
    console.log(error)
    req.flash('error','Something Went Wrong')
    return res.redirect('/login')
...
exports.editDepartment1=async(req,res)=>{
  try {
    const newData={dep_code:req.body.dep_code,department_name:req.body.department_name}
    const data=await departmentModel.findOne({where:{id:req.params.id}})
    if (data) {
      if(data.dep_code!=newData.dep_code||data.department_name!=newData.department_name){
        const department_Check = await departmentModel.findOne({
          where: {
            [Sequelize.Op.or]: [
...
exports.deleteDepartment=async(req,res)=>{
  try {
    const data=await departmentModel.findOne({where:{id:req.params.id}})
    const datadestroy=await departmentModel.destroy({where:{id:req.params.id}})
...
exports.editCompany=async(req,res)=>{
  try {
    ...
    return res.render('./admin/editCompany.ejs',{findCompany:findCompany,messages:req.flash()})
  } catch (error) {
    console.log(error)
    req.flash('error','Something Went Wrong')
    return res.redirect('/login')
...
exports.fin_years=async(req,res)=>{
  try {
    ...
    return res.render('./admin/fin_years.ejs',{year_Data:year_Data,messages:req.flash()})
  } catch (error) {
    console.log(error)
    req.flash('error','Something Went Wrong')
    return res.redirect('/login')
...
exports.edit_fin_year=async(req,res)=>{
  try {
    ...
    return res.render('./admin/edit_fin_year.ejs',{data:data,fin_year_data:fin_year_data,messages: req.flash()})
  } catch (error) {
    console.log(error)
    req.flash('error','Something Went Wrong')
    return res.redirect('/login')
...
exports.g_jobpage=async(req,res)=>{
  try {
    ...
    return res.render('./general/jobTitle.ejs',{data:data,messages:req.flash()})
  } catch (error) {
    console.log(error)
...
exports.jobTItleEdit=async(req,res)=>{
  try {
    ...
    return res.render('./general/jobTItleEdit.ejs',{data:data,editJob:editJob,messages:req.flash()})
  } catch (error) {
    console.log(error)
    req.flash('error','Something Went Wrong')
    return res.redirect('/login')
  ...
  try {
    ...
    if(data){
          if(data.job_title_name!=newData.job_title_name){
            const checkJob=await g_jobModel.findOne({where:{job_title_name:newData.job_title_name}})
            if(!checkJob){
...
exports.Delete_jobtitles=async(req,res)=>{
  try {
    const data=await g_jobModel.findOne({where:{id:req.params.id}})
    if(data){
      const dataDestroy=await g_jobModel.destroy({where:{id:req.params.id}})
...
exports.m_industry=async(req,res)=>{
  try {
    ...
    return res.render('./general/industry.ejs',{data:data,messages:req.flash()})
  } catch (error) {
    console.log(error)    
    req.flash('error','Something Went Wrong')
    return res.redirect('/login')
...
exports.edit_m_industry=async(req,res)=>{
  try {
    ...
    return res.render('./general/industryEdit.ejs',{data:data,editInd:editInd,messages:req.flash()})
  } catch (error) {
    console.log(error)
    req.flash('error','Something Went Wrong')
    return res.redirect('/login')
...
exports.Delete_m_industry=async(req,res)=>{
  try {
    const data1=await g_industryModel.findOne({where:{id:req.params.id}})
...
exports.m_skillPage=async(req,res)=>{
  try {
    ...
    return res.render('./general/skillsPage.ejs',{data:data,messages:req.flash()})
  } catch (error) {
    console.log(error) 
    req.flash('error','Something Went Wrong')
    return res.redirect('/login')   
...
exports.edit_m_skills=async(req,res)=>{
  try {
    ...
    return res.render('./general/skillPageEdit.ejs',{data:data,skill:skill,messages:req.flash()})
  } catch (error) {
    console.log(error)
    req.flash('error','Something Went Wrong')
    return res.redirect('/login')
...
exports.edit_m_skills1=async(req,res)=>{
  try {
    ...
    if (data) {
      ...
      console.log('data not submited')
      req.flash('error',`${data.skill_name} Is Not Updated`)
      return res.redirect('/admin/m_skillPage')
  }    
  } catch (error) {
    console.log(error)
...
exports.Delete_m_skills=async(req,res)=>{
  try {
    const d=await skillModel.findOne({where:{id:req.params.id}})
...
exports.ad_ref_page=async(req,res)=>{
  try {
    ...
    return res.render('./general/advert_ref.ejs',{data:data,messages:req.flash()})
  } catch (error) {
    console.log(error)   
    req.flash('error','Something Went Wrong')
    return res.redirect('/login') 
...
exports.edit_m_advertPage=async(req,res)=>{
  try {
    ...
    return res.render('./general/advPageEdit.ejs',{data:data,adv:adv,messages:req.flash()})
  } catch (error) {
    console.log(error)
    req.flash('error','Something Went Wrong')
    return res.redirect('/login')
...
exports.edit_m_advert_ref=async(req,res)=>{
  try {
    ...
    const data1=await advert_refModel.findOne({where:{ad_ref_name:req.body.ad_ref_name}})
    console.log(data)
    ...
    if (!data1) {
      ...
      console.log('data not submited')
      req.flash('error',`${req.body.ad_ref_name} Is Not Updated Or Already In Database`)
...
exports.Delete_m_advert_ref=async(req,res)=>{
  const d=await advert_refModel.findOne({where:{id:req.params.id}})
  try {
...
exports.adminEmployee=async(req,res)=>{
  try {
    ...
    return res.render('./admin/adminEmployee.ejs',{EmpData:EmpData,messages:req.flash()})
  } catch (error) {
    console.log(error)
  }  
}  
...
exports.adminAddEmployee=async(req,res)=>{
  try {
    ...
    return res.render('./admin/adminAddEmployee.ejs',{EmpData:EmpData,department:department,employees:employees,messages:req.flash()})
  } catch (error) {
    console.log(error)
    req.flash('error','Something Went Wrong')
    return res.redirect('/login')
...
exports.employeeView=async(req,res)=>{
  try {
    ...
    const data = await EmployeeModel.findOne({ where: { id: req.params.id } });
      ...
      return res.render('./general/employeeView.ejs', { d: data,messages:req.flash() });
  } catch (error) {
    console.log(error)
    req.flash('error','Something Went Wrong')
    return res.redirect('/login')
...
exports.candidateList=async(req,res)=>{
  try {
    ...
    return res.render('./general/candidateList.ejs',{PData:PData,AData:AData,AllData:AllData,messages:req.flash()})
  } catch (error) {
    console.log(error)
    req.flash('error','something went wrong')
    return res.redirect('/login')
